...
def _default_project_root() -> Path:
    for cand in (
        Path("/home/sanggyu1008/project/UmaxFormer"),
        Path("/mnt/d/project/UmaxFormer"),
    ):
        if cand.exists():
            return cand
    return Path.cwd()
...
DEFAULT_GODAS_BASE = PROJECT_ROOT / "data/raw/godas"
DEFAULT_SODA_BASE = PROJECT_ROOT / "data/raw/soda"
