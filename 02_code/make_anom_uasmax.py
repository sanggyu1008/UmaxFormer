...
CR20V2_INFILE = Path('/mnt/d/project/01_ENSO/01_data/01_raw/20crv2/uwnd.10m.1871-2012.nc')
CR20V2_OUTFILE = Path('/mnt/d/project/01_ENSO/01_data/02_interim/20crv2/uasmax.uwnd.10m.1871-2012.anom_1x2.nc')
